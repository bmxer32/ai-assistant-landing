...
Шесть примеров внедрения — от барбершопа до магазина автозапчастей. В каждой карточке
мини-диалог с ботом и две цифры результата.

![Кейсы](screenshots/cases.png)
...
<div align="center">
  <img src="screenshots/mobile.png" width="330" alt="Мобильная версия">
</div>
...
Единственная внешняя зависимость — Google Fonts; без интернета шрифты подменятся системными,
вёрстка не поедет.
